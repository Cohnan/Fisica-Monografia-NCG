...
\subsection{High Level Summary}
    ...
    \item Noncommutative Quantum Mechanics
        ...
        \item Constructions for Fuzzy Spheres
            ...
            \item Coherent states: \lbtext{Perelomov coherent states (maybe I will call them ``vectors'' instead of states)}: elements of the action of group $X = SU(2)/U(1)$ on the state $|n, n_3\rangle$. Given by $|z\langle = \cdots \in H^n_c$, as discussed in [21]. The label $z = -tan(\frac{\theta}{2})e^{-i \phi}$
