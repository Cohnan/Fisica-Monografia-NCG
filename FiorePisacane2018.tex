...
\subsection*{Important Facts}
    ...
    \item There are two conditions on the potential. They are what allow to approximate the time independent Schrodinger equation $9$ as a $1$-dimensional harmonic oscillator (2D: equation $10$, 3D: equation $36$)
    ...
    \item By making $k$ and $\cut E$ diverge while having the region $\nu_{\cut E} = \{r \st V(r) \leq \cut E\}$ go to $\{r = 1\}$.
