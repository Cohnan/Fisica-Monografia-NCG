...
Now, for $a \in \acal_1 = M_2(\CC)$ hermitian, let $a_\pm = a_1 \pm i a_2$, so that $a = a_0 + a_+ \sigma_+ + a_- \sigma_- + a_3 \sigma_3$. Recall that $\pi_{1/2}(J_k) = \frac{\sigma_k}{2}$, $k = 1, \dots, 3$, hence
\begin{equation*}
    [D_1, a] = 
    \begin{pmatrix}
    0 & a_+ & -a_+ & 0\\
