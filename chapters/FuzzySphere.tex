...
\begin{proof}
It is straightforward to verify that: $\mathcal J_N$ is antilinear and antiunitary, $\mathcal J_N^2 = - 1$, $\mathcal J_N (\acal_N \mathcal\otimes 1) J_N^{-1} \subset \acal_N \mathcal\otimes M_2(\CC) \subset \bcal(\hcal_N)$, and $\mathcal J_N \dcal_N = + \dcal_N \mathcal J_N$; hence $\mathcal J_N$ is a real structure.
