...
$ are the actions of $J_3$, $J^\pm \in i\,su(2)$ on $L^2(S^2)$ respectively. Eig. vectors: orth. basis of $\hcal$, Spectrum $= \{\pm l\} = \ZZ$ with multiplicities $2l$.%: L^2(S^2) \otimes \CC^2 \to L^2(S^2) \otimes \CC^2 = \oplus_{l \in \bb N} (\pi_l \otimes \pi_{1/2})(\mathcal D)$
...
- \rtext{\textbf{Theorem}}: the two spectral triples induce the same distance in the state space of $\acal_N$.
\end{frame}
...
- This identification of points in $S^2$ with coherent states $\psi^N: \acal_N \to L^2(S^2)$ is $SU(2)$-equivariant \& the distance between them will be $SU(2)$-invariant.
