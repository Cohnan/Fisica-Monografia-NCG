...
- The spectral triple \rtext{$(\acal_N, H_N = V_j \otimes \CC^2, D_N)$}
    \begin{itemize}
...
\rtext{$(\acal_N, \hcal_N = \mathcal A_N \otimes \CC^2 \cong \bigoplus_{l =1}^N H_l, \mathcal D_N \equiv \bigoplus_{l =1}^N D_l)$}, where:
\begin{multline}
